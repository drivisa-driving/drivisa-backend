<template>
  <div>
    <div>
      <div class="content"><p>This Privacy Policy describes Our policies and procedures on the collection, use and
        disclosure of Your
        ...
        <ul>
          <li><p><strong>You</strong> means the individual accessing or using the Service, or the company, or other
            legal
            entity on behalf of which such individual is accessing or using the Service, as applicable.</p></li>
          <li><p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this
            Agreement)
            refers to drivisa.com.</p></li>
          ...
          <li><strong>Website</strong> refers to drivisa.com, accessible from
            https://drivisa.com
          </li>
          ...
          <li><p><strong>Service Provider</strong> means any natural or legal person who processes the data on
            ...
            or
            to assist the Company in analyzing how the Service is used.</p></li>
        ...
        <ul>
          <li><p><strong>Necessary / Essential Cookies</strong></p>
            ...
            <p>Purpose: These Cookies are essential to provide You with services available through the Website and
              ...
              We
              only use these Cookies to provide You with those services.</p></li>
        ...
        <ul>
          <li>By visiting this page on our website: https://drivisa.com/#/suggestion</li>
        </ul>
      </div>
    </div>
