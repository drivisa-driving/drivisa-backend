  ...
  <MasterStudentLayout>
          ...
          <v-card>
            ...
            >
              <div
                ...
                :key="reply.id"
              >
                <div class="border p-2 rounded mx-3 mt-3">
                  {{ reply.reply }}
                </div>
              </div>
            </div>
    ...
    <div>
      ...
      >
        ...
        <Column sortable hidden field="complaint_date" header="Complaint Date"></Column>
...
export default {
  name: "Complaint",
  components: { Paginator, MasterStudentLayout },
  data() {
    return {
      perPage: 10,
      pageNo: 1,
