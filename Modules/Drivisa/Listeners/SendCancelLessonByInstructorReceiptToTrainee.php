...
class SendCancelLessonByInstructorReceiptToTrainee implements ShouldQueue
{
    /**
    ...
    public function handle(CancelLessonByInstructor $event)
    {
        ...
        $additional_costs = $event->additional_costs;
        $cancellationFee = $event->cancellationFee;
        $this->sendViaPostmark($lesson,  $refundAmount, $additional_costs, $cancellationFee);
    }

    public function sendViaPostmark($lesson,  $refundAmount, $additional_costs, $cancellationFee)
    {
