...
class InstructorProfileAppTransformer extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'availability' => $this->availabilityData($filter_duration, $this->points()->where('is_active', true), $point_id),
        ];
    }
