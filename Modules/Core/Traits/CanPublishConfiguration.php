...
trait CanPublishConfiguration
{
    ...
    public function publishConfig($module, $fileName)
    {
        ...
        $this->mergeConfigFrom($this->getModuleConfigFilePath($module, $fileName), strtolower("ceo.$module.$fileName"));
        $this->publishes([
            $this->getModuleConfigFilePath($module, $fileName) => config_path(strtolower("ceo/$module/$fileName") . '.php'),
        ], 'config');
    }
