...
<head>
    ...
    <title>{{ trans('user::auth.reset_password',[],$locale) }}</title>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0"
                                ...
                                <tr style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; box-sizing: border-box; font-size: 14px; margin: 0; padding: 0;">
                                    <td class="content-block"
                                        ...
                                        valign="top">
                                        {{ trans('user::auth.reset_password',[],$locale) }}
                                    </td>
                                </tr>
                                <tr style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; box-sizing: border-box; font-size: 14px; margin: 0; padding: 0;">
                                    <td class="content-block"
                                        ...
                                        valign="top">
                                        {{ trans('user::auth.to_reset_complete_form',[],$locale) }}{{env('FRONTEND_URL')}}
                                        /complete-reset-password?username={{$user['username']}}&code={{$code}}.
                                    </td>
                                </tr>
                                <tr style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; box-sizing: border-box; font-size: 14px; margin: 0; padding: 0;">
                                    <td class="content-block"
                                        style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 20px;"
                                        valign="top">
                                        <a href="{{env('FRONTEND_URL')}}/complete-reset-password?username={{$user['username']}}&code={{$code}}"
                                           class="btn-primary"
